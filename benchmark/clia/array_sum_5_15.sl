(set-logic LIA)
(synth-fun findSum ( (y1 Int) (y2 Int) (y3 Int) (y4 Int) (y5 Int) )Int ((Start Int ( 0 1 2 3 4 5  15 y1 y2 y3 y4 y5 (+ Start Start) (- Start Start) (ite BoolExpr Start Start))) (BoolExpr Bool ((< Start Start) (<= Start Start) (> Start Start) (>= Start Start) (and BoolExpr BoolExpr) (or BoolExpr BoolExpr) (not BoolExpr BoolExpr)))))
(declare-var x1 Int)
(declare-var x2 Int)
(declare-var x3 Int)
(declare-var x4 Int)
