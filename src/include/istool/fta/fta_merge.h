...
PFTA mergeFTAForwardCart(FTA* x, FTA* y, bool is_cut, TimeGuard* guard);
...
PFTA mergeFTAForwardMultiCart(const FTAList& fta_list, bool is_cut);
...
std::vector<std::pair<PSemantics, EdgeStorage>> mergeEdgeGroup(
