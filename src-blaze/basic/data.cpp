...
std::string Data::toString() const { return value->toString(); }
...
Value *Data::get() const { return value.get(); }
...
namespace {
    void _cartesianProduct(int pos, const DataStorage &separate_data,
